...
public class MediatorImplTests
{
    ...
    public async Task SendAsync_ShouldExecutePipelineBehaviorsInCorrectOrder()
    {
        ...
        services.AddTransient<IPipelineBehavior<TestRequestWithResponse, string>>(sp => new LoggingBehavior<
            TestRequestWithResponse,
            string
        >(executionLog, "Behavior1"));

        services.AddTransient<IPipelineBehavior<TestRequestWithResponse, string>>(sp => new LoggingBehavior<
            TestRequestWithResponse,
            string
        >(executionLog, "Behavior2"));
    ...
    public async Task SendAsyncVoid_ShouldExecutePipelineBehaviorsInCorrectOrder()
    {
        ...
        services.AddSingleton(executionLog);
        services.AddTransient<IRequestHandler<TestRequest>>(sp => new TestRequestHandler(executionLog));

        services.AddTransient<IPipelineBehavior<TestRequest>>(sp => new LoggingBehavior<TestRequest>(executionLog, "Behavior1"));

        services.AddTransient<IPipelineBehavior<TestRequest>>(sp => new LoggingBehavior<TestRequest>(executionLog, "Behavior2"));
    ...
    public async Task SendAsync_ShouldAllowBehaviorsToModifyRequest()
    {
        ...
        services.AddTransient<
            IPipelineBehavior<TestRequestWithResponse, string>,
            RequestModifierBehavior<TestRequestWithResponse, string>
        >();
    ...
    public async Task SendAsync_ShouldAllowBehaviorsToModifyResponse()
    {
        ...
        services.AddTransient<
            IPipelineBehavior<TestRequestWithResponse, string>,
            ResponseModifierBehavior<TestRequestWithResponse, string>
        >();
    ...
    public async Task SendAsync_ShouldAllowBehaviorsToShortCircuitPipeline()
    {
        ...
        services.AddTransient<IPipelineBehavior<TestRequestWithResponse, string>>(sp => new ShortCircuitBehavior<
            TestRequestWithResponse,
            string
        >(executionLog));
    ...
    public async Task SendAsyncVoid_ShouldAllowBehaviorsToShortCircuitPipeline()
    {
        ...
        // Add short-circuit behavior first
        services.AddTransient<IPipelineBehavior<TestRequest>>(sp => new ShortCircuitBehavior<TestRequest>(executionLog));

        // Add another behavior that should not be executed
        services.AddTransient<IPipelineBehavior<TestRequest>>(sp => new LoggingBehavior<TestRequest>(
            executionLog,
            "ShouldNotExecute"
        ));
    ...
    public async Task SendAsync_ShouldThrow_WhenNoHandlerIsRegistered(bool withResponse)
    {
        ...
        {
            var request = new TestRequestWithResponse("Test");
            await Should.ThrowAsync<InvalidOperationException>(async () => await mediator.SendAsync(request));
        }
        else
        {
            var request = new TestRequest("Test");
    ...
    public async Task PipelineBehaviors_ShouldHandleExceptionsCorrectly()
    {
        ...
        services.AddTransient<IPipelineBehavior<TestRequestWithResponse, string>>(sp => new LoggingBehavior<
            TestRequestWithResponse,
            string
        >(executionLog, "ExceptionBehavior"));
